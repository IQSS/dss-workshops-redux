...
$$
csat_i = b_{0}1 + b_1expense_i + e_i
$$
</div>
...
<div class="alert alert-secondary">
$$
logit(p(hypev_i=1)) = b_{0}1 + b_1agep_i + b_2sex_i + b_3sleep_i + b_4bmi_i 
$$
</div>
...
<div class="alert alert-secondary">
$$
logit \left( p(hypev_i=1)\right) = ln \left(\frac{p(hypev_i = 1)}{1-p(hypev_i = 1)}\right) = ln \left(\frac{p(hypev_i = 1)}{p(hypev_i = 0)}\right) 
$$
</div>
...
<div class="alert alert-secondary">
$$
normexam_{ij} = b_0 + b_1standLRT_{ij} + U_{0j} + e_{ij}
$$
</div>
